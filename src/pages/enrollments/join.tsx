...
const joinSchema = z.object({
    inviteCode: z.string().min(3, "Код приглашения обязателен"),
});
...
const EnrollmentsJoin = () => {
    ...
    return (
        <CreateView className="class-view">
            ...
            <h1 className="page-title">Присоединиться по коду</h1>
            <div className="intro-row">
                <p>Введите код приглашения, полученный от координатора.</p>
            </div>
                            ...
                            >
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>
                                                Код приглашения <span className="text-orange-600">*</span>
                                            </FormLabel>
                                            <FormControl>
